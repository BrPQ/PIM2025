...
public class OpenTicketDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_open_ticket_detail);
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null,
                response -> {
                    ...
                    if (listaDeAnexos.isEmpty()) {
                        ...
                        semAnexosView.setText("Nenhum anexo enviado.");
                ...
                error -> {
                    Log.e("CarregarAnexosAberto", "Erro: " + error.toString());
                }) {
            @Override
